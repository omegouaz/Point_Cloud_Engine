...
import sys
from .utility import join, get_file_list
from .visualization import draw_registration_result_original_color
from .posegraph import optimize_posegraph_for_refined_scene
...
def multiscale_icp(source,
    ...
    for i, scale in enumerate(range(len(max_iter))):  # multi-scale approach
        ...
        source_down = o3d.geometry.PointCloud.voxel_down_sample(source, voxel_size[scale])
        target_down = o3d.geometry.PointCloud.voxel_down_sample(target, voxel_size[scale])
